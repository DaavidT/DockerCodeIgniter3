                        ...
                        <div class="contenedorNavegador">
                            <div class="contenedorPadding">
                                <div class="contenedorPath d-flex flex-row flex-wrap">
                                    <?php if(isset($navegador)) {
                                        ?>
                                    <a href="<?= base_url('index.php/Dashboard/') ?>">Inicio</a>
                                    <?php
                                        foreach($navegador as $folder){?>
                                    <a
                                        href="<?= base_url('index.php/Dashboard/folder/'.$folder['id']) ?>">/<?= $folder['nombre']?></a>
                                    <?php }}?>
                                </div>
                            </div>
                        </div>
